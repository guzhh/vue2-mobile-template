...
export const encryptByCBC = ({ message, key1 = process.env.VUE_APP_SECRET_KEY, iv1 = process.env.VUE_APP_SECRET_IV }) => {
...
// DES(CBC)解密
// eslint-disable-next-line max-len
export const decryptByCBC = ({ message, key1 = process.env.VUE_APP_SECRET_KEY, iv1 = process.env.VUE_APP_SECRET_IV }) => {
